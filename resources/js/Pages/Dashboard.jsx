...
const PRESET_COLORS = [
    ...
    { name: 'Violet-Indigo', value: 'from-violet-500 to-indigo-600' },
    ...
    { name: 'Rose-Fuchsia', value: 'from-rose-500 to-fuchsia-500' },
    ...
    { name: 'Green-Lime', value: 'from-green-500 to-lime-500' },
    ...
    { name: 'Cyan-Indigo', value: 'from-cyan-500 to-indigo-600' },
    ...
    { name: 'Gray-Orange', value: 'from-gray-800 to-orange-500' },
    { name: 'Stone-Orange', value: 'from-stone-600 to-orange-500' },
...
export default function Dashboard({ shortcuts = [], userShortcuts = [] }) {
    ...
    const publicUrl = `http://hfg093wdn44.sn.mynetname.net:8081/shortly-app/u/${auth.user.username}`;
